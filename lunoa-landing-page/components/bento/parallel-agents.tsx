...
const ParallelCodingAgents: React.FC<ParallelCodingAgentsProps> = ({ className = "" }) => {
  ...
  const agents = [
    {
      icon: <CheckmarkIcon />,
      title: "Find Web Developer",
      tokens: "90% match",
      model: "AI-Match",
      branch: "Lunoa/web-dev-search...",
    },
    {
      icon: <RefreshIcon />,
      title: "Source PCB Components",
      tokens: "85% match",
      model: "AI-Match",
      branch: "Lunoa/component-sourcing...",
    },
    {
      icon: <SparklesIcon />,
      title: "Verify Logistics Partner",
      tokens: "92% match",
      model: "AI-Match",
      branch: "Lunoa/logistics-vetting...",
    },
  ]
