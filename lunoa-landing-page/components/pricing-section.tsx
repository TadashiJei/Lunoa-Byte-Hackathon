  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Ideal for small businesses exploring trusted partnerships.",
      features: [
        "Basic Trust Verification",
        "Limited Partner Discovery",
        "Basic Security Shield",
        "Up to 5 Secure Messages/Day",
        "Lunoa Branding on Public Profile",
      ],
    ...
    },
    {
      ...
      monthlyPrice: "$99",
      annualPrice: "$79",
      description: "Perfect for growing MSMEs seeking secure collaborations.",
      features: [
        "Advanced Trust Verification",
        "AI-Powered Partner Matching",
        "Full Security Shield (Phishing, Malware)",
        "Unlimited Secure Messaging & Video Calls",
        "Secure Contract & Escrow Management",
    ...
    {
      name: "Enterprise",
      monthlyPrice: "Custom", // Changed to Custom as per Lunoa info
      annualPrice: "Custom", // Changed to Custom
      description: "Custom solutions for large organizations with dedicated needs.",
      features: [
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your business needs, from growing MSMEs to large enterprises.
          </p>
        </div>
        <div className="pt-4">
        ...
        {pricingPlans.map((plan) => (
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
                  ...
                  <div className="flex justify-start items-center gap-1.5">
                    ...
                    >
                      {plan.name === "Enterprise" ? (
                        <span className="invisible text-2xl">Custom</span>
                      ) : (
                        <span className="invisible">
                          {plan.monthlyPrice.length > plan.annualPrice.length
                            ? plan.monthlyPrice
                            : plan.annualPrice}
                        </span>
                      )}
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Basic" ? "text-gray-800" : plan.name === "Standard" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              >
                {plan.name === "Basic" ? "Key Features:" : "Everything in Basic +"}
              </div>
